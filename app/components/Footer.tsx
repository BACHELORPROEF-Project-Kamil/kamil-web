		...
		<footer className="w-full bg-accent-green text-body-white">
			<div className="max-w-7xl mx-auto py-16 px-6">
				<div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8">
					...
					<div className="text-center md:text-left">
						<h4 className="font-body-bold text-body text-body-white mb-6 font-section-title">Contact</h4>
						<ul className="space-y-4">
							<li className="flex flex-col">
								<span className="text-xs font-bold uppercase tracking-widest text-white/50 mb-1">Naam</span>
								<span className="text-base">Arno Baeck</span>
							</li>
							<li className="flex flex-col">
								<span className="text-xs font-bold uppercase tracking-widest text-white/50 mb-1">Telefoon</span>
								<span className="text-base">+32 474 99 69 78</span>
							</li>
							<li className="flex flex-col">
								<span className="text-xs font-bold uppercase tracking-widest text-white/50 mb-1">E-mail</span>
								<a href="mailto:arno.baeck@student.ehb.be" className="text-base hover:text-accent-orange transition-colors">
			...
			<div className="w-full bg-black/10 border-t border-white/5 py-6">
